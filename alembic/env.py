...
from app.models import Base # Import the common Base
# The individual model files are imported in app/models/__init__.py
...
target_metadata = Base.metadata # Use the common Base's metadata
